...
class SignosVitalesForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'imc': forms.NumberInput(attrs={'class': 'form-control', 'readonly': True}), #campos imc para el form de crear consultas
        }
    ...
    def clean_presion_arterial(self):
        ...
        if pa and not re.match(r'^(1[01][0-9]|120|12[0-9]|1[3-9][0-9]|140)/(60|6[0-9]|70|7[0-9]|80|8[0-9]|90)$', pa):
            raise ValidationError('Dato de presión arterial no valido (ejemplo de dato a ingresar: "120/80")')
        return pa