...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id_historial', models.CharField(editable=False, max_length=9, primary_key=True, serialize=False, unique=True, verbose_name='Id Historial')),
                ...
                ('usa_metodos_anticonceptivos', models.BooleanField(default=False, verbose_name='Usa métodos anticonceptivos')),
        ...
        migrations.AddField(
            model_name='usuario',
            name='role',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='usuarios.role'),
        ),
        migrations.AddField(
            model_name='usuario',
