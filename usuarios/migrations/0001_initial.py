    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('carrera_o_puesto', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='usuarios.area')),
                ('role', models.ForeignKey(default=0, null=True, on_delete=django.db.models.deletion.SET_NULL, to='usuarios.role')),
            ],
            options={
                'abstract': False,
            },
